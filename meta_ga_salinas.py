...
data = scipy.io.loadmat(os.path.dirname(os.path.abspath(__file__))+"/data/salinas/SalinasA_corrected.mat")
x = data['salinasA_corrected']
data2 = scipy.io.loadmat(os.path.dirname(os.path.abspath(__file__))+"/data/salinas/SalinasA_gt.mat")
gt = data2['salinasA_gt']
gt[gt==10]=2
gt[gt==11]=3
gt[gt==12]=4
gt[gt==13]=5
...
hp_dataset_name="metadata_salinas_ml.csv"
